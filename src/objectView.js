...
const toTableRows = (translate, rows, cols)=>translate("tableRows", jet.forEach(rows, (vals, key)=>toTableRow(translate, vals, cols, key)));
...
const toList = (translate, pairs)=>translate("list", jet.forEach(pairs, (item, key)=>toListRow(translate, item, key)));
